        ...
        <div id="Master">
            ...
            <div id="Master_Left">
                ...
                <div id="MasterLeft_Down">
                                    <div style="direction:rtl;font-family:Tahoma;font-size:13px;color:#e6e6e6;">از طریق 3 ایمیل زیر می توانید با ما در ارتباط باشید <br /> پاسخ در کمتر از دوساعت داده خواهد شد<br />با تشکر</div>
                    <div style="direction:ltr;font-family:Tahoma;font-size:30px;color:#e6e6e6;">News@eghbaldar.com</div>
                    <div style="direction:ltr;font-family:Tahoma;font-size:30px;color:#e6e6e6;">Info@EmrozNews.ir</div>
                    <div style="direction:ltr;font-family:Tahoma;font-size:30px;color:#e6e6e6;">Ads@EmrozNews.ir</div>
                </div>
            </div>
        </div>
        <div id="footer">
